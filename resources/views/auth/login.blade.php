        ...
        <div class="grid md:grid-cols-1 items-center gap-4 max-w-6xl w-full">
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              <div class="mb-8">
                <h3 class="text-gray-800 dark:text-white text-3xl font-extrabold">Sign in</h3>
                <p class="text-gray-500 dark:text-white text-sm mt-4 leading-relaxed">Sign in to your account and explore a world of possibilities. Your journey begins here.</p>
              </div>

              <div>
                <label class="text-gray-800 dark:text-white text-sm mb-2 block">User name</label>
              ...
              <p class="text-sm !mt-8 text-center dark:text-white text-gray-800">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
