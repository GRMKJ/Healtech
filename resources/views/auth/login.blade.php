            ...
            <form class="space-y-4">
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="uname" type="text" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600" placeholder="Correo" />
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="passk" type="password" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600" placeholder="Contraseña" />
